...
defmodule NOAA.TableFormatter do
  ...
  ## Example
      ...
      iex> NOAA.TableFormatter.split_into_columns(list, [ "a", "b", "c" ])
      [ ["1", "4"], ["2", "5"], ["3", "6"] ]
  ...
  ## Examples
      iex> NOAA.TableFormatter.printable("a")
      "a"
      iex> NOAA.TableFormatter.printable(99)
      "99"
  """
  ...
  ## Example
      ...
      iex> NOAA.TableFormatter.widths_of(data)
      [ 6, 8 ]
  """
  ...
  ## Example
      iex> widths = [5,6,99]
      iex> NOAA.TableFormatter.format_for(widths)
      "~-5s | ~-6s | ~-99s~n"
  """
  ...
  ## Example
        iex> widths = [5,6,9]
        iex> NOAA.TableFormatter.separator(widths)
        "------+--------+----------"
  """
